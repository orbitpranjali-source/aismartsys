...
const PortfolioSection = () => {
  ...
  return (
    <section id="portfolio" className="relative section-padding overflow-hidden">
      <GlowOrb className="w-72 h-72 top-0 left-0" color="secondary" />
          ...
          {projects.map((p, i) => (
            ...
            >
              <div className={`relative h-52 bg-gradient-to-br ${p.gradient} flex items-center justify-center overflow-hidden`}>
                <span className="text-foreground/10 text-8xl font-heading font-bold group-hover:scale-110 transition-transform duration-500">
                  0{i + 1}
                </span>
              ...
              <div className="p-7">
                ...
                <Button variant="ghost" size="sm" className="text-primary hover:text-accent p-0 h-auto">
