      ...
      <div className="relative z-10">
        ...
        <section className="pt-32 pb-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 reveal-on-scroll text-white tracking-tight">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto reveal-on-scroll">
        ...
        <section className="section-padding pt-0">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-12 reveal-on-scroll text-white">Our Expertise</h2>
        ...
        <section className="section-padding pt-0">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center reveal-on-scroll text-white">Why Choose Us</h2>
